...
### 신규 등록
- [#290](https://github.com/edwardkim/rhwp/issues/290) — cross-run 탭 감지가 inline_tabs 무시 → exam_math.hwp p.7 #18 "수열" 문항 첫 줄 우측 정렬 오류. SVG/PDF 시각 비교로 발견, 트레이스로 `paragraph_layout.rs:1213-1226` cross-run 탭 종류 판정 누락 확정. 하이퍼-워터폴 절차 진행 중 (`local/task290`)
