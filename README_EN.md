<p align="center">
  <img src="assets/logo/logo-256.png" alt="hwpio logo" width="128" />
</p>

<h1 align="center">hwpio</h1>
...
**hwpio** is paldyn's hosted redistribution of the open-source HWP/HWPX viewer · editor engine [rhwp](https://github.com/edwardkim/rhwp), served at [hwpio.paldyn.com](https://hwpio.paldyn.com/). Open Korean documents in the browser, no installation required.
...
<p align="center">
  <img src="assets/screenshots/render-example-1.png" alt="hwpio rendering example — KTX route map" width="700" />
</p>

## Engine — rhwp

The parser · renderer · editor engine used by hwpio is the open-source project [rhwp](https://github.com/edwardkim/rhwp). Current engine version **v0.7.13** (MIT License, © 2025-2026 Edward Kim and contributors).
...
This repository (paldyn/hwpio) manages the redistribution and hosting artifacts for the [rhwp](https://github.com/edwardkim/rhwp) engine. Contributions split by category:
...
- **hwpio hosting / redistribution (CI, gh-pages workflow, domain config, etc.)**: please open [Issues](https://github.com/paldyn/hwpio/issues) / [PRs](https://github.com/paldyn/hwpio/pulls) on this repository.
...
hwpio redistribution artifacts (additions in this repository): MIT License — Copyright (c) 2026 paldyn
