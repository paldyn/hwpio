...
| **6** | **BinData 해제 인프라** (zlib raw deflate + DocInfo BinDataItem 플래그 + API) | 신규 |
| **7** | **내부 CFB 파싱** (OlePres000 / OOXMLChartContents / Contents 추출) | 신규 |
| **8** | **OOXML 차트 네이티브 SVG 렌더 + EMF 폴백** | 신규 |
