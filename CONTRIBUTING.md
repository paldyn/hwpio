...
```bash
# 클론
git clone https://github.com/paldyn/hwpio.git
cd hwpio
...
- [`good first issue`](https://github.com/paldyn/hwpio/labels/good%20first%20issue) 라벨이 붙은 이슈
- 렌더링 불일치 제보 (한컴과 비교하여 스크린샷 첨부)
- 문서 오타/개선
- [Discussions](https://github.com/paldyn/hwpio/discussions)에서 질문/아이디어 제안
...
1. [이슈 생성](https://github.com/paldyn/hwpio/issues/new?template=bug_report.md)
...
```
[본인 Fork]                              [paldyn/hwpio]

1. Fork (GitHub UI)
   paldyn/hwpio → myid/hwpio

2. Clone
   git clone https://github.com/myid/hwpio.git
   cd hwpio
...
- **[Discussions](https://github.com/paldyn/hwpio/discussions)** — 질문, 아이디어, 기술 토론
- **[Issues](https://github.com/paldyn/hwpio/issues)** — 버그 리포트, 기능 요청
