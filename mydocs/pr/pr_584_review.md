...
3. ⏳ SVG 생성 — `output/svg/pr584_before/{exam_science,exam_kor,exam_eng,exam_math}/` + `output/svg/pr584_after/...` (작업지시자 시각 판정용) + 회귀 sweep 영역
4. ⏳ 작업지시자 시각 판정 (★ 게이트)
5. ⏳ 통과 시 cherry-pick + 옵션 C 충돌 통합 + devel merge + push
6. ⏳ PR #584 close 댓글 + 처리 보고서 (`pr_584_report.md`) 작성 + archives 이동
