...
3. ⏳ SVG 생성 — `output/svg/pr593_before/exam_kor/` + `output/svg/pr593_after/exam_kor/` (작업지시자 시각 판정용) + 회귀 sweep 영역
4. ⏳ 작업지시자 시각 판정 (★ 게이트)
5. ⏳ 통과 시 cherry-pick + devel merge + push
6. ⏳ PR #593 close 댓글 + 처리 보고서 (`pr_593_report.md`) 작성 + archives 이동
